(function () {
  ...
  Ship.prototype.draw = function (ctx) {
    ...
    ctx.lineTo(
      x - this.radius * Math.cos(7 * Math.PI / 6),
      y - this.radius * Math.sin(7 * Math.PI / 6)
    );
    ctx.lineTo(x, y);
    ctx.lineTo(
      x - this.radius * Math.cos(-1 * Math.PI / 6),
      y - this.radius * Math.sin(-1 * Math.PI / 6)
    );
    ctx.closePath();
    if (this.invulnerable) {
  ...
  Ship.prototype.move = function () {
    ...
    if (this.pos[1] - (this.radius * Math.sin(-Math.PI / 6)) > this.game.yEnd) {
      this.pos[1] = this.game.yEnd + this.radius * Math.sin(-Math.PI / 6);
