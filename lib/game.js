(function () {
  ...
  var Game = Centipede.Game = function (xDim, yDim) {
    ...
    this.yStart = 100;
    this.yEnd = 820;
    this.xStart = (xDim / 2) - 300;
    this.xEnd = (xDim / 2) + 300;
    this.level = 0;
    this.ship = new Centipede.Ship({
      pos: [this.xStart + (this.xEnd / 2), this.yStart + (this.yEnd * 3 / 4)],
      game: this,
      fillColor: "#66a9fa",
      strokeColor: "#2222aa",
    });
  ...
  Game.prototype.topLeftEmpty = function () {
    return this.centipede.every(function (segment) {
      return segment.pos[0] > this.xStart + segment.radius ||
  ...
  Game.prototype.rightmostSquarePos = function () {
    var squarePos = this.xEnd - (this.xEnd % Centipede.SQUARE_SIZE);
    return squarePos - (Centipede.SQUARE_SIZE / 2);
  };

  Game.prototype.leftmostSquarePos = function () {
    var squarePos = this.xStart - (this.xStart % Centipede.SQUARE_SIZE);
    return squarePos + (Centipede.SQUARE_SIZE / 2);
  };

  Game.prototype.lowestSquarePos = function () {
    var squarePos = this.yEnd - (this.yEnd % Centipede.SQUARE_SIZE);
    return squarePos - (Centipede.SQUARE_SIZE / 2);
  };

  Game.prototype.highestSquarePos = function () {
    var squarePos = this.yStart - (this.yStart % Centipede.SQUARE_SIZE);
    return squarePos + (Centipede.SQUARE_SIZE / 2);
  };
