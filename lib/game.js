(function () {
  ...
  var Game = Centipede.Game = function (xDim, yDim) {
    ...
    setTimeout(this.addSpider.bind(this), 30000);
    setTimeout(this.addDropper.bind(this), 20000);
  };
  ...
  Game.prototype.addDropper = function () {
    ...
    this.droppers.push(new Centipede.Dropper({
      pos: [xPos, yPos],
      game: this,
      vel: [Math.random() * this.level - 0.5 * this.level, this.level * 0.25]
    }));
    setTimeout(this.addDropper.bind(this), Math.random() * (150 - this.level) * 100);
  };
