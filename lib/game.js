(function () {
  ...
  Game.prototype.setSquareSize = function () {
    ...
    var ySpace = window.innerHeight - 116;
  ...
  Game.prototype.draw = function (ctx) {
    ...
    ctx.fillText("Score: " + this.score, this.xStart + (Centipede.squareSize / 2), 30);
    ctx.fillText("Level: " + this.level, this.xDim / 2 - (2.5 * Centipede.squareSize), 30);
    ctx.fillText("Lives: " + this.lives, this.xDim / 2 + (7.5 * Centipede.squareSize), 30);
